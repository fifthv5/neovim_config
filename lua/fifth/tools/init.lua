...
function M.setup()
	local group = vim.api.nvim_create_augroup("willIncludeFormatter", { clear = true })
	...
	vim.api.nvim_create_autocmd("BufWritePre", {
		...
		callback = function(args)
			...
			require("will.tools.include_formatter").format(args.buf)
		end,
	})
	...
	vim.api.nvim_create_user_command("Skel", function()
		require("will.tools.skeleton").insert()
	end, {})
	...
	require("will.tools.cpp_extract").setup()
end
